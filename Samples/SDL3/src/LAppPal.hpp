...
public:
    ...
    */
    static void ConvertMultiByteToWide(const char* multiByte, wchar_t* wide, int wideSize);

    /**
    * @brief ワイド文字からマルチバイト文字に変換する
    *
    * @param[in]   wide        変換元
    * @param[out]  multiByte   格納先
    * @param[in]   multiByteSize 格納先の大きさ
    */
    static void ConvertWideToMultiByte(const wchar_t* wide, char* multiByte, int multiByteSize);
